...
class gui():
    ...
    def run_gui(self):
        ...
        if self.state == 0:
            ...
            # weather widget
            ttk.Label(mainframe, text = f"The weather is currently: {self.weather}").grid(column=1, row=0, sticky=W)

            # temperature widget
            ttk.Label(mainframe, text = f"The temperature is currently: {self.temp:.02f}°C").grid(column=1, row=1, sticky=W)
            ...
            # humidity widget
            ttk.Label(mainframe, text = f"The humidity is currently: {self.humidity}%").grid(column=1, row=2, sticky=W)
            ...
            # wind widget
            ttk.Label(mainframe, text = f"The wind speed is currently: {self.wind} km/h").grid(column=1, row=3, sticky=W)
